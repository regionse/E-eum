...
KEEP = [
    ...
    #  ★ 2026-08-10 — 금지 되물음 체(①-3)의 «예외»가 사는지.
    #    「~하고 싶은지 몰라도 괜찮아요」는 질문이 아니라 «안심»이다. 죽이면 안 된다.
    ('안심(몰라도 괜찮)', '어떤 일을 하고 싶은지 몰라도 괜찮아요.'),
    ('되짚기(모르겠다 하셨)', '뭘 하고 싶은지 모르겠다고 하셨죠.'),
]
...
DROP = [
    ...
    #  ★ 2026-08-10 — 금지 되물음 (프롬프트 «가장 중요한 원칙»). holdout2 실측 문장 그대로.
    ('금지 되물음(실측1)', '대신 어떤 일을 하고 싶으신지, 혹은 평소에 어떤 활동을 할 때 마음이 편하신지부터 천천히 이야기 나눠볼까요?'),
    ('금지 되물음(실측2)', '대신 어떤 일을 하고 싶으신지, 혹은 어떤 일을 해보셨는지부터 천천히 이야기 나눠볼까요?'),
    ('금지 되물음(명령꼴)', '어떤 일을 하고 싶은지 편하게 말씀해 주세요.'),
    ('금지 되물음(뭘)', '뭘 하고 싶으세요?'),
]
